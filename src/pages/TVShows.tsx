...
import { Tv, SlidersHorizontal, ChevronRight } from 'lucide-react';
import {
  getDiscoverTVPage,
  getDiscoverTV,
} from '@/services/tmdb';
...
export default function TVShows() {
  ...
  const mobileFetchMore = useCallback(
    (page: number) => getDiscoverTVPage(genreId, page, mobileSort, language).then(r => r.movies),
    ...
    >
      {addonRoot && createPortal(
        <div className="flex items-center gap-2 ml-4">
          ...
          <span className="font-display font-bold text-xl text-white">TV Shows</span>
